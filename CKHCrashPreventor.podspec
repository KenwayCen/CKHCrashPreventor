...
Pod::Spec.new do |s|
  ...
  #s.name         = "CKHCrashPreventor"
  #s.version      = "0.0.1"
  #s.summary      = "A short description of CKHCrashPreventor."
  ...
  #s.author             = { "cenkunhua" => "1250578320@qq.com" }
  # Or just: s.author    = "cenkunhua"
  # s.authors            = { "cenkunhua" => "1250578320@qq.com" }
  # s.social_media_url   = "http://twitter.com/cenkunhua"
  ...
  #s.source       = { :git => "http://EXAMPLE/CKHCrashPreventor.git", :tag => "#{s.version}" }
